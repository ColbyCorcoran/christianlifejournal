...
struct PrayerRequestDetailView: View {
    ...
    private var scripturePassages: [String] {
        guard let scripture = prayerRequest.scripture, !scripture.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty else {
            return []
        }
    ...
    private var organizationSection: some View {
        ...
        let hasScripture = !scripturePassages.isEmpty
        
        if hasCategories || hasTags || hasScripture {
            VStack(alignment: .leading, spacing: 12) {
                // Categories and Tags in HStack
                ...
                // Scripture section below categories and tags
                if hasScripture {
                    VStack(alignment: .leading, spacing: 8) {
